...
def add_employee():
    if txtName.get() == "" or txtAge.get() == "" or txtDoj.get() == "" or txtEmail.get() == "" or comboGender.get() == "" or txtContact.get() == "" or txtAddress.get(
            1.0, END) == "":
        messagebox.showerror("Erorr", "Please Fill All the Fields")
        return
...
btnClear = Button(btn_frame, command=clearAll, text="Clear Input", width=15, font=("Calibri", 16, "bold"), fg="white",
                  bg="#f39c12",
